...
export const metadata: Metadata = {
  ...
  description: "Comment Hors-Piste collecte et protège vos données personnelles (RGPD).",
...
export default function ConfidentialitePage() {
  return (
    <>
      ...
      <p>
        La présente politique décrit comment <strong>Hors-Piste</strong> traite vos données personnelles,
      ...
      <p>
        Hors-Piste utilise uniquement des cookies <strong>strictement nécessaires</strong> au fonctionnement
