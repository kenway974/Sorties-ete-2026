...
export default function SortiesEnfantsLoading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="bg-brand-navy py-12 px-4">
        <div className="max-w-5xl mx-auto space-y-3">
          <div className="h-6 bg-white/10 rounded-full w-20" />
          <div className="h-9 bg-white/10 rounded-full w-64 max-w-full" />
          <div className="h-4 bg-white/10 rounded-full w-96 max-w-full" />
        </div>
      </div>
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="h-3 shimmer-bg rounded-full w-36 mb-6" />
